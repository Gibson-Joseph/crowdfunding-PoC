...
const FundCard = ({
    ...
    return (
        <div className='sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer' onClick={handleClick}>
            ...
            <div className='flex flex-col p-4 mb-[18px]'>
                <div className='flex flex-row items-center'>
                    <img src={tagType} alt="tag" className='w-[17px] h-[17px] object-contain' />
                    <p className='ml-[12px] mt-[2px] font-epilogue font-medium text-[12px] text-[#808191]'>Categort</p>
                </div>
                <div className='block'>
                ...
                <div className='flex items-center mt-[20px] gap-[12px]'>
                    ...
                    <p className='flex-1 font-epilogue font-normal text-[12px] text-[#808181] truncate'>by <span className='text-[#b2b3bd]'>{owner}</span> </p>
                </div>
            </div>
        </div>
    )
